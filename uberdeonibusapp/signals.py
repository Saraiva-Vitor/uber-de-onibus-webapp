...
def criar_horarios_poltronas(sender, instance, created, **kwargs):
    if created:
        ...
        for i in range(6, 22): 
            ...
            horario = BusSchedule.objects.create(route=instance, data=schedule_date, hora=schedule_time)
            
            # Vincule automaticamente as poltronas
            for numero_poltrona in range(1, 49):  # Vinculando 48 poltronas como exemplo
                Poltrona.objects.create(route=instance, horario=horario ,numero=numero_poltrona)